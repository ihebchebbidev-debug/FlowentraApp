...
const ARTICLES = [
  ...
  { name: 'Emergency Repair', sku: 'IMP-SRV-003', description: 'Urgent breakdown call-out', type: 'service', category: 'Services', status: 'active', stock: '', minStock: '', costPrice: '', sellPrice: '', basePrice: 120, duration: 1.5, supplier: '', location: '' },
  ...
  { name: 'User Training Session', sku: 'IMP-SRV-007', description: 'End-user software training', type: 'service', category: 'Services', status: 'active', stock: '', minStock: '', costPrice: '', sellPrice: '', basePrice: 100, duration: 1.5, supplier: '', location: '' },
