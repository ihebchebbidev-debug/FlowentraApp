...
-- =============================================================================
INSERT INTO "Contacts" ("FirstName","LastName","Name","Email","Phone","Company","Position","Status","Type",
                        "Address","Cin","MatriculeFiscale","CreatedDate","CreatedBy","IsDeleted")
SELECT split_part(v."Name", ' ', 1),
       COALESCE(NULLIF(substr(v."Name", length(split_part(v."Name", ' ', 1)) + 2), ''), v."Name"),
       v."Name", v."Email", v."Phone", v."Company", v."Position", v."Status", v."Type",
       v."Address", v."Cin", v."MatriculeFiscale", v."CreatedDate", v."CreatedBy", v."IsDeleted"
FROM (VALUES
...
) AS v("Name","Email","Phone","Company","Position","Status","Type","Address","Cin","MatriculeFiscale","CreatedDate","CreatedBy","IsDeleted")
ON CONFLICT DO NOTHING;
