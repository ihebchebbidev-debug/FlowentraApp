...
const CAPTIONS_FR: string[] = [
  ...
  'La page Paie est l\'endroit où vous exécutez la paie mensuelle. Elle applique automatiquement la loi fiscale tunisienne — cotisations CNSS (9,18% salarié, 16,57% patronal), tranches IRPP progressives, CSS de solidarité (1%) et calcul du net.',
  ...
  'L\'aperçu montre pour chaque employé : brut, retenue CNSS salarié (9,18%), cotisation CNSS patronale (16,57%), IRPP, CSS (1% du brut imposable), primes, retenues présence, et net final.',
  'Cliquer un employé ouvre le détail complet du bulletin — décomposition ligne par ligne au format officiel tunisien, avec tous les composants (CNSS, IRPP, CSS, primes, retenues) étiquetés clairement.',
  'L\'export PDF génère un bulletin formaté prêt à remettre à l\'employé ou à archiver. Sélectionner plusieurs employés télécharge chaque bulletin individuellement en séquence.',
  ...
  'Le tableau CNSS détaille les cotisations par employé et par période. Les taux sont configurés par tenant (salarié 9,18%, patronal 16,57%, CSS 1%) et versionnés — mettez-les à jour une fois et chaque paie future utilise les nouvelles valeurs.',
