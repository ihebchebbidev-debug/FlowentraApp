...
const CAPTIONS_FR: string[] = [
  ...
  'Les boutons d\'accès rapide ouvrent la Conformité, les Rapports, le Journal d\'audit et la scorecard Performance fournisseur.',
  ...
  'Une fois la facture réglée, marquez-la comme soumise à Facture en Ligne. Le statut passe à « Envoyé » avec horodatage — votre tableau de bord conformité se met à jour en direct, vous savez toujours ce qui reste à traiter.',
  ...
  'Toute combinaison de filtres peut être enregistrée comme vue nommée — « Réception en attente — Acme », « Brouillons de mon équipe ». Elles sont conservées localement dans votre navigateur : votre flux quotidien à un clic.',
  ...
  'Le constructeur de BC est pensé clavier : Alt+N ajoute une ligne et Entrée depuis la dernière cellule crée une ligne — saisissez une longue commande sans jamais toucher la souris.',
