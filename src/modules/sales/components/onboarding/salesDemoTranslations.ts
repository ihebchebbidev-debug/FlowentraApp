...
const CAPTIONS_FR: string[] = [
  ...
  'Voyez vos ventes de trois façons — un Tableau dense, une Liste aérée, et un Kanban pour glisser les affaires dans l’exécution.',
  ...
  'Le tableau Kanban suit l’exécution visuellement — des colonnes pour Créée, En cours, Facturée et Clôturée, chacune affichant son compte et sa valeur totale.',
  'Glissez une vente en avant au fur et à mesure de son exécution — d’en cours à facturée à clôturée — et le statut et le journal d’activité se mettent à jour aussitôt.',
