    ...
    <EditorSection title="⚡ Form Settings" defaultOpen={false}>
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          <Label className="text-px-11 font-medium text-foreground/70 flex items-center gap-1">
        ...
        {formSettings.webhookUrl && (
          <div className="space-y-1">
            <Label className="text-px-11 font-medium text-foreground/70">Method</Label>
            <div className="flex gap-1">
              {['POST', 'GET'].map(m => (
                <button
                  key={m}
                  onClick={() => updateSettings({ webhookMethod: m })}
                  className={`text-px-10 px-3 py-1 rounded-md border transition-colors ${
        ...
        {/* Success Message */}
        <div className="space-y-1">
          <Label className="text-px-11 font-medium text-foreground/70">Success Message</Label>
          <Input
        ...
        {/* Success Action */}
        <div className="space-y-1">
          <Label className="text-px-11 font-medium text-foreground/70">After Submit</Label>
          <div className="flex gap-1">
            {[
              ...
              <button
                ...
                className={`text-px-10 px-2.5 py-1 rounded-md border transition-colors flex-1 ${
        ...
        {formSettings.successAction === 'redirect' && (
          <div className="space-y-1">
            <Label className="text-px-11 font-medium text-foreground/70">Redirect URL</Label>
            <Input
        ...
        {/* Email To */}
        <div className="space-y-1">
          <Label className="text-px-11 font-medium text-foreground/70">Notify Email (optional)</Label>
          <Input
            ...
            className="h-7 text-xs"
          />
          <p className="text-px-9 text-muted-foreground/50">Requires backend integration</p>
        </div>
      </div>
    </EditorSection>
  );
