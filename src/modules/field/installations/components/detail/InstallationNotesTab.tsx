...
interface InstallationNotesTabProps {
  notes: Note[];
  isLoading: boolean;
  isCreating: boolean;
  isDeleting: boolean;
...
export function InstallationNotesTab({
  notes,
  isLoading,
  isCreating,
  isDeleting,
      ...
      <CardContent className="space-y-4">
        ...
        {isAdding && (
          <div className="p-4 rounded-lg border bg-muted/30 space-y-3">
            <Textarea
              placeholder={t('detail.notes.placeholder', 'Enter your note...')}
              value={newNote}
        ...
        {notes.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium mb-2">{t('detail.notes.no_notes')}</h3>
          </div>
        ) : null}
      </CardContent>
    </Card>
