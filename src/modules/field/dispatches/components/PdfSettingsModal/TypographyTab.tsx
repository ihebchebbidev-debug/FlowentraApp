    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Choose the primary font family for your dispatch report
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4 p-4 bg-muted/50 rounded-lg">
            ...
            >
              DISPATCH REPORT HEADER ({settings.fontSize.header}pt)
            </div>
            ...
            >
              This is body text that will be used for main content, customer information, dispatch details, and table data. ({settings.fontSize.body}pt)
            </div>
