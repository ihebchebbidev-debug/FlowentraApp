    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure optional watermark text for your dispatch reports
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure the appearance of data tables in your dispatch reports
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
