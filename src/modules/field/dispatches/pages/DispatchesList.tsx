...
export default function DispatchesList() {
  ...
  const exportConfig: ExportConfig = {
    ...
    availableColumns: [
      { key: 'jobNumber', label: t('dispatches.export.job_number'), category: t('dispatches.export.categories.basic') },
      { key: 'serviceOrderId', label: t('dispatches.export.service_order_id'), category: t('dispatches.export.categories.basic') },
      { key: 'serviceOrderNumber', label: t('dispatches.export.service_order_number'), category: t('dispatches.export.categories.basic') },
      { key: 'title', label: t('dispatches.export.title'), category: t('dispatches.export.categories.basic') },
      { key: 'description', label: t('dispatches.export.description'), category: t('dispatches.export.categories.basic') },
      { key: 'status', label: t('dispatches.export.status'), category: t('dispatches.export.categories.basic') },
      { key: 'priority', label: t('dispatches.export.priority'), category: t('dispatches.export.categories.basic') },
      { key: 'customer.company', label: t('dispatches.export.customer_company'), category: t('dispatches.export.categories.customer') },
      { key: 'customer.contactPerson', label: t('dispatches.export.customer_contact'), category: t('dispatches.export.categories.customer') },
      { key: 'customer.phone', label: t('dispatches.export.customer_phone'), category: t('dispatches.export.categories.customer') },
      { key: 'customer.email', label: t('dispatches.export.customer_email'), category: t('dispatches.export.categories.customer') },
      { key: 'scheduledStartTime', label: t('dispatches.export.scheduled_start'), category: t('dispatches.export.categories.schedule') },
      { key: 'scheduledEndTime', label: t('dispatches.export.scheduled_end'), category: t('dispatches.export.categories.schedule') },
      { key: 'estimatedDuration', label: t('dispatches.export.estimated_duration'), category: t('dispatches.export.categories.schedule') },
      { key: 'assignedTechnicians', label: t('dispatches.export.assigned_technicians'), category: t('dispatches.export.categories.assignment'), transform: (techs: any[]) => Array.isArray(techs) ? techs.map(t => t.name).join(', ') : '' },
      { key: 'createdAt', label: t('dispatches.export.created_date'), category: t('dispatches.export.categories.timeline'), transform: (date: string) => new Date(date).toLocaleDateString() },
      { key: 'updatedAt', label: t('dispatches.export.updated_date'), category: t('dispatches.export.categories.timeline'), transform: (date: string) => date ? new Date(date).toLocaleDateString() : 'N/A' },
    ]
  };
