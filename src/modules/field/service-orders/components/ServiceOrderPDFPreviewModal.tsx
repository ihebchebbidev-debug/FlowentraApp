      ...
      try {
        ...
        if (isMounted) {
          ...
          try {
            ...
            console.warn('[ServiceOrderPDF] Company logo could not be resolved:', logoError);
          }
          setPdfSettings({
            ...settings,
            company: await resolveCompanyForPdf(settings.company, logoBase64 || '', getRecordTenantId(serviceOrder))
          });
        }
      } catch (error) {
