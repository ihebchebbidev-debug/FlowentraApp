export const fr = {
  scheduling: {
    ...
    today_status: 'Statut du jour',
    available_now: 'Disponible maintenant',
    available_today: 'Disponible aujourd\'hui',
    not_working_today: 'Ne travaille pas aujourd\'hui',
    not_working_now: 'Ne travaille pas actuellement',
    on_leave_today: 'En congé aujourd\'hui',
    outside_hours: 'Hors heures de travail',
    current_leave: 'Congé en cours',
    until: 'jusqu\'au',
    no_schedule: 'Aucun planning configuré',
