...
const CAPTIONS_FR: string[] = [
  ...
  'Une recherche et un filtre de priorité gardent la file gérable — concentrez-vous d’abord sur les jobs urgents, ou trouvez un ordre précis dans une longue liste.',
  'Dépliez un ordre de service pour voir ses jobs — ou, en mode installation, regroupés par installation. Un point de priorité coloré signale l’urgence de chacun.',
  'Survolez un job pour le tableau complet — client, adresse du site, durée estimée et les compétences exactes requises — pour planifier avec tous les faits sous les yeux.',
  ...
  'Besoin de planifier toute une journée d’un coup ? Le Remplissage auto programme chaque job non planifié pour vous — en choisissant le meilleur technicien et le premier créneau libre dans ses heures de travail.',
  'Il prévisualise exactement ce qu’il va faire — combien de jobs, sur combien de techniciens — et ne touche jamais aux affectations existantes ni au passé. Vous gardez le contrôle.',
  ...
  'Les réglages d’affichage façonnent le tableau : mode ordre de service ou installation, jour ou semaine, inclure les week-ends, et colorer les jobs par statut, priorité, ordre ou technicien.',
  ...
  'Les permissions posent les garde-fous : autoriser ou bloquer la planification dans le passé, confirmer en cas de chevauchement, et contrôler qui peut modifier ou désaffecter les envois — une planification sûre pour chaque rôle.',
