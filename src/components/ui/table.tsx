...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-9 px-3 text-left align-middle text-table-header uppercase text-muted-foreground/60 select-none [&:has([role=checkbox])]:pr-0",
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-3 py-2 align-middle text-table-cell [&:has([role=checkbox])]:pr-0",
