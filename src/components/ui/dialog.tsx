...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-h2 font-heading text-foreground",
      className
    )}
    {...props}
  />
