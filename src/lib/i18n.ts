...
// Global status labels used by reporting/dashboard translators (useStatusLabel).
// Keys mirror the ids in src/config/entity-statuses/*.config.ts.
(enTranslation as any).statuses = {
  ...((enTranslation as any).statuses ?? {}),
  draft: 'Draft',
  created: 'Created',
  new: 'New',
...
const frTranslation = {
  ...
  goods_receipts: 'Bons de réception',
  ...
  dispatches: 'Interventions',
  'time-expenses': 'Temps & Frais',
  timeExpenses: 'Temps & Frais',
  planner: 'Planning',
  'website-builder': 'Créateur de Site',
  workflow: 'Workflows',
  dynamic_forms: 'Formulaires Dynamiques',
  lookups: 'Listes',
  external: 'Externe',
  reporting: 'Rapports',
  projects: 'Projets',
  ...
  service: 'Service',
  system: 'Système',
  expand_sidebar: 'Déplier le menu',
  ...
  sidebarSub: {
    dashboardBuilder: 'Créateur de Tableau',
    crmDashboard: 'Tableau CRM',
    fieldDashboard: 'Tableau Field',
    reporting: 'Rapports',
    salesDashboard: 'Tableau Ventes',
    serviceDashboard: 'Tableau Services',
    financeDashboard: 'Tableau Finances',
    hrDashboard: 'Tableau RH',
    purchaseDashboard: 'Tableau Achats',
...
// French global status labels (mirrors enTranslation.statuses).
(frTranslation as any).statuses = {
  ...((frTranslation as any).statuses ?? {}),
  draft: 'Brouillon',
  created: 'Créé',
  new: 'Nouveau',
  ...
  ready: 'Prêt',
  ready_for_planning: 'Prêt à planifier',
  ready_for_invoice: 'Prêt à facturer',
  ...
  lost: 'Perdu',
  cancelled: 'Annulé',
  follow_up_pending: 'Suivi en attente',
};
