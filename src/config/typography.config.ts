...
export const typographyConfig: TypographyConfig = {
  ...
  rawScale: {
    ...
    sm:    { size: '0.8125rem', lh: '1.25rem'  },
    base:  { size: '0.875rem',  lh: '1.375rem' },
    lg:    { size: '1rem',      lh: '1.5rem'   },
    xl:    { size: '1.125rem',  lh: '1.6rem'   },
    '2xl': { size: '1.375rem',  lh: '1.8rem'   },
    '3xl': { size: '1.75rem',   lh: '2.1rem'   },
    '4xl': { size: '2.125rem',  lh: '2.5rem'   },
    '5xl': { size: '2.75rem',   lh: '1.1'      },
    '6xl': { size: '3.5rem',    lh: '1'        },
    '7xl': { size: '4.25rem',   lh: '1'        },
  },
  pixelScale: {
    '7':  '7px',
    '8':  '8px',
